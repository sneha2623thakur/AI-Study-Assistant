...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen font-sans overflow-hidden select-none bg-gradient-to-br from-sky-100 via-pink-50 to-sky-200 text-slate-800">
      ...
      {page === 'student' && (
        <div className="flex flex-1 overflow-hidden relative bg-gradient-to-br from-sky-200 via-sky-100 to-pink-100">
          ...
          <aside className="w-80 border-r border-sky-200 bg-white/90 backdrop-blur-md p-6 hidden md:flex flex-col justify-between z-10 shadow-lg">
